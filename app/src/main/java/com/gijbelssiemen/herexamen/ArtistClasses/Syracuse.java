...
public class Syracuse extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.syracuse);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(Color.argb(255, 64, 64, 64));
        getSupportActionBar().setTitle("SYRACUSE");
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.syracuse, options);

        ImageView i = (ImageView) findViewById(R.id.imageView);

        loadBitmap(R.drawable.syracuse, i);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText(R.string.syracuse_description);
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer ...params){
            data = params[0];
            return Syracuse.decodeSampledBitmapFromResource(activity.getResources(), data, 400, 400);
        }
