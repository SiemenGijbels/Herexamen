...
public class Easter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("EASTER");
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.easter, options);

        ImageView i = (ImageView) findViewById(R.id.imageView);

        loadBitmap(R.drawable.easter, i);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText(R.string.easter_description);
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer ...params){
            data = params[0];
            return Easter.decodeSampledBitmapFromResource(activity.getResources(), data, 400, 400);
        }
