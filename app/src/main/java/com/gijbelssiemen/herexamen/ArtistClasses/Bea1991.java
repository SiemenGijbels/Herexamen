...
public class Bea1991 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bea_1991);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(Color.argb(255, 64, 64, 64));
        getSupportActionBar().setTitle("BEA1991");
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.bea1991, options);

        ImageView i = (ImageView) findViewById(R.id.imageView);

        loadBitmap(R.drawable.bea1991, i);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText(R.string.bea1991_description);
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer ...params){
            data = params[0];
            return Bea1991.decodeSampledBitmapFromResource(activity.getResources(), data, 400, 400);
        }
