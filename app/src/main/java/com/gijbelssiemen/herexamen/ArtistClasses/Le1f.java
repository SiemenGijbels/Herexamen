...
public class Le1f extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.le1f);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(Color.argb(255, 64, 64, 64));
        getSupportActionBar().setTitle("LE1F");
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.le1f, options);

        ImageView i = (ImageView) findViewById(R.id.imageView);

        loadBitmap(R.drawable.le1f, i);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText(R.string.le1f_description);
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer ...params){
            data = params[0];
            return Le1f.decodeSampledBitmapFromResource(activity.getResources(), data, 400, 400);
        }
