...
public class Sheniqua extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sheniqua);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(Color.argb(255, 64, 64, 64));
        getSupportActionBar().setTitle("SHENIQUA WORLD TOUR");
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.sheniqua, options);

        ImageView i = (ImageView) findViewById(R.id.imageView);

        loadBitmap(R.drawable.sheniqua, i);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText(R.string.sheniqua_world_tour_description);
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer ...params){
            data = params[0];
            return Sheniqua.decodeSampledBitmapFromResource(activity.getResources(), data, 400, 400);
        }
