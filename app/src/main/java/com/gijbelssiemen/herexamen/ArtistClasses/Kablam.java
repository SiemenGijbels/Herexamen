...
public class Kablam extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.kablam);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(Color.argb(255, 64, 64, 64));
        getSupportActionBar().setTitle("KABLAM");
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.kablam, options);

        ImageView i = (ImageView) findViewById(R.id.imageView);

        loadBitmap(R.drawable.kablam, i);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText(R.string.kablam_description);
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer ...params){
            data = params[0];
            return Kablam.decodeSampledBitmapFromResource(activity.getResources(), data, 400, 400);
        }
