...
public class AsaMoto extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.asa_moto);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(Color.argb(255, 64, 64, 64));
        getSupportActionBar().setTitle("ASA MOTO");
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.asa_moto, options);

        ImageView i = (ImageView) findViewById(R.id.imageView);

        loadBitmap(R.drawable.asa_moto, i);

        TextView t = (TextView) findViewById(R.id.textView);
        t.setText(R.string.asa_moto_description);
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer ...params){
            data = params[0];
            return AsaMoto.decodeSampledBitmapFromResource(activity.getResources(), data, 400, 400);
        }
